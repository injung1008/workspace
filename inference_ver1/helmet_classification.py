...
# #SAMPLE
# #릴리즈 해주기 
# trt_engine_path = f'/DATA_17/ij/trt_inference/make_trt/helmet2.trt'
...
# helmet_cls = HELMET_CLASSIFICATION()
# #엔진로드
# helmet_cls.load(trt_engine_path)

# #이미지 preprocess & 스택 쌓기
# img_stack = helmet_cls.img_process(img)

# #input 버퍼할당해 주지 않고 데이터를 바로 보낼때 
# input_data = torch.tensor(img_stack).cuda() 

# #inference
# result = helmet_cls.inference(input_data)

# #postprocess
# outputs = helmet_cls.make_output(result)
