...
def make_parser():
    ...
    parser.add_argument("--w1_path", default='/DATA/source/ij/pytorch_classfication/worker_wear_weights/1.pt')
    parser.add_argument("--w2_path", default='/DATA/source/ij/pytorch_classfication/worker_wear_weights/2.pt')
    parser.add_argument("--w3_path", default='/DATA/source/ij/pytorch_classfication/worker_wear_weights/3.pt')
    return parser
...
# 데이터셋 만들기
data_dir = '/DATA/source/ij/pytorch_classfication/worker_wear_datasets/'
