...
import cv2 as cv
import csv
dir_path = '/DATA/source/ij/pytorch_hat_train_04/datasets/test123'
...
class Classifier:
    def __init__(self):
        self.path2weights = '/DATA/source/ij/pytorch_classfication/weights_osNet/f2_acc.pt'
#         self.ResNext = ResNext50()
        self.load()
                
    def load(self):      
        path2weights = self.path2weights
        self.model = osnet_x1_0().to(DEVICE)
...
#         pred_zip.append(pred)
        ...
        image = Image.open('/DATA/source/ij/pytorch_hat_train_04/datasets/test123/0_100.jpg')
#         image = test_transformer(image)
        image = np.array(image)
        print('transe 후 사진',image)



# # # #         image1 = image1.transpose(2, 0, 1)
#         print('original 사진',image1[0])
# #         print('original 사진',image1.shape)
#         image2 = test_transformer(image)
#         print('transe 후 사진',image2.shape)
#         print('transe 후 사진',image2)

#         return pred_zip

classifier = Classifier()

img = cv.imread('/DATA/source/ij/pytorch_hat_train_04/datasets/test123/0_100.jpg')
classifier.load()
...
# # test_dataset = hat_test_Dataset(data_dir, test_transformer, 'test123')
# test_loader = DataLoader(test_dataset, batch_size=64, shuffle=True, num_workers=2)
# path2weights = '/DATA/source/ij/pytorch_classfication/weights_osNet/f2_acc.pt'
