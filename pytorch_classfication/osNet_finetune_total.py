...
def make_parser():
    ...
    parser.add_argument("--w1_path", default='/DATA/source/ij/pytorch_classfication/weights_osNet/1.pt')
    parser.add_argument("--w2_path", default='/DATA/source/ij/pytorch_classfication/weights_osNet/2.pt')
    return parser
...
# 데이터셋 만들기
data_dir = '/DATA/source/ij/pytorch_classfication/data/'
