...
#             config.max_workspace_size = 1 << 28 # 256MiB
            ...
            profile.set_shape("input", [1,3,224,224], [64,3,224,224], [64,3,224,224]) #배치, 채널, 세로(h), 가로(w)
...
def main():
    onnx_file_path = '/DATA_17/ij/trt_inference/make_trt/hel1.onnx'
    engine_file_path = '/DATA_17/ij/trt_inference/make_trt/hel1.trt'
